                                ...
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                                ...
                                                <a href="{{route('op.approved', ['id' => $item->id])}}"  class="btn btn-primary " id="approve">Approve</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('op.disapproved', ['id' => $item->id])}}" method="POST">
                                                {{csrf_field()}}
                                            ...
                                            <div class="modal-body" id="modal{{$item->id}}" >
                                                    ...
                                                    @foreach ($item->plan->planItem as $i)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                    <input  class="form-control input-sm" name="amount{{$item->id}}"  readonly value="{{$i->pivot->estimated_budget}}">
                                                            </div>
                                                        </div>                                                        
                                                    @endforeach
                                                    <hr>
