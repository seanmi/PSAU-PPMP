                            ...
                            @foreach ($submissions as $item)
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center btn-group">
                                        <a href="{{route('user.plan.items', ['id' => $item->id])}}" class="btn btn-warning ">View Submission</a>
                                        <a href="{{route('bac.consolidation', ['id' => $item->id])}}" class="btn btn-success ">Consolidation</a>
                                    </td>
                                </tr>
                                {{-- Modal Submit Plan --}}
