    ...
    <!-- DataTables CSS -->
    <link href="{{asset('css/vendor/datatables-plugins/dataTables.bootstrap.css')}}" rel="stylesheet">
    <!-- DataTables Responsive CSS -->
    <link href="{{asset('css/vendor/datatables-responsive/dataTables.responsive.css')}}" rel="stylesheet">
