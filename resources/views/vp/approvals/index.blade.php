                                ...
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                                ...
                                                <a href="{{route('vp.plan.items', ['id' => $item->plan->id])}}" class="btn btn-warning ">Plan Items</a>
                                                <a href="{{route('vp.approved', ['id' => $item->id])}}"  class="btn btn-primary " id="approve">Approve</a>
