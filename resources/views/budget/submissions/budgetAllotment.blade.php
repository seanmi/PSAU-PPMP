            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form  action="{{route('budget.store', ['id' => $submission_id])}}" id="form" method="POST" class="form_budget">
                            {{csrf_field()}}
                    ...
                    <div class="row" id="fields">
                        @foreach ($budgets as $item)
                            ...
                            <div class="col-sm-2 form-group btn-group">
                                ...
                                <a href="{{route('budget.delete', ['id'=> $item->id])}}" class="btn btn-danger btn-sm">Remove</a>
                            </div> 
                            {{-- Modal --}}
...
//   s                  
                    ...
                    addedItem += '<div class="row" id="item_fields">';
                    addedItem += '<div class="col-sm-1 form-group"><input type="text" name="user_id[]" value="'+item.id+'"  class="form-control input-sm gen" readonly></div>';
                    addedItem += '<div class="col-sm-3 form-group"><input type="text" class="form-control input-sm gen" id="email" placeholder="'+item.username+'" readonly></div>';
                    addedItem += '<div class="col-sm-4 form-group"><input type="text" class="form-control input-sm unit" id="email" placeholder="'+item.deptname+'" readonly></div>';
                    addedItem += '<div class="col-sm-2 form-group"><input type="number" name="amount[]" class="form-control input-sm price" required></div>';
                    addedItem += '<div class="col-sm-2 form-group"><button type="button" class="btn btn-danger btn-sm" data-id="'+item.id+'">Remove</button></div>';
                    addedItem += '</div>';
                    ++counter;
