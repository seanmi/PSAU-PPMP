            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="" data-toggle="modal" data-target="#modalLoginForm" class="btn btn-success ">Create Submission</a>
                    </div>
                    <!-- /.panel-heading -->
                                ...
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                                ...
                                                <a href="<?php echo e(route('consolidation', ['year', $item->year])); ?>"  class="btn btn-success ">Consolidation</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header text-center">
                                                ...
                                                <?php $__currentLoopData = $item->submissionUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($sub->user_lvl ===4): ?>
                                                    <div class="md-form mb-5">
                                                    <label data-error="wrong" data-success="right" for="defaultForm-title"><?php echo e($sub->name); ?></label>
                                                        <input type="text" id="defaultForm-title" class="form-control validate" name="title" value="<?php echo e($sub->pivot->submitted == 0 ? "Not Yet submitted" : "Submitted"); ?>" readonly>
                                                    </div>
                                                <?php endif; ?>
