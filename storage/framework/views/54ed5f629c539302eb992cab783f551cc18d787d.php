    ...
    $('[data-toggle="tooltip"]').tooltip(); 
        ...
        $elm = $('#aw');
            ...
            $('#list_item').change(function(){ 
                ...
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="text" name="item_id[]" value="'+id+'"  class="form-control input-sm gen" id="email" placeholder="'+gen+'" readonly></div>';
                addedItem += '<div class="col-lg-2 col-md-12 form-group"><input type="text" class="form-control input-sm gen" id="email" placeholder="'+gen+'" data-toggle="tooltip" title="'+gen+'" readonly></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="text" class="form-control input-sm unit" id="email" placeholder="'+unit+'" data-toggle="tooltip" title="'+unit+'" readonly></div>';
                addedItem += '<div class="col-lg-1 col-md-12  form-group"><input type="number" class="form-control input-sm price" id="email" placeholder="'+"₱"+price.toFixed(2)+'" data-toggle="tooltip" title="'+"₱"+price.toFixed(2)+'"  readonly></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="number" data-price="'+price+'" name="quantity[]" class="form-control input-sm price" id="email" placeholder="Quantity" required></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="number"  name="q1[]" class="form-control input-sm price" id="email" placeholder="Quarter 1" required></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="number"  name="q2[]" class="form-control input-sm price" id="email" placeholder="Quarter 2" required></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="number"  name="q3[]" class="form-control input-sm price" id="email" placeholder="Quarter 3" required></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><input type="number"  name="q4[]" class="form-control input-sm price" id="email" placeholder="Quarter 4" required></div>';
