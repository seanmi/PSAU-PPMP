                    ...
                    <div class="row" id="fields">
                        ...
                        <?php $__currentLoopData = $plan->planItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-2 col-md-12 form-group btn-group">
                                <a  data-toggle="modal" data-target="#<?php echo e($item->id); ?>" class="btn btn-primary btn-sm">Edit</a>
                            ...
                            <form action="<?php echo e(route('user.plan.items.edit', [$plan->id, $item->id])); ?>" method="POST">
                                <?php echo e(csrf_field()); ?>

                                <div class="modal-body mx-3">
                                <div class="md-form mb-5">
                                    <label data-error="wrong" data-success="right" for="defaultForm-title">Quantity</label>
                                    <input type="text" name="quantity" id="defaultForm-title" class="form-control validate" value="<?php echo e($item->pivot->quantity); ?>" >
                                </div>

                                <div class="md-form mb-5">
                                    <label data-error="wrong" data-success="right" for="defaultForm-instruction">Q1</label>
                                    <input type="text" name="q1" id="defaultForm-instruction" class="form-control validate" value="<?php echo e($item->pivot->q1); ?>" >
                                </div>

                                <div class="md-form mb-5">
                                    <label data-error="wrong" data-success="right" for="defaultForm-instruction">Q2</label>
                                    <input type="text" name="q2" id="defaultForm-instruction" class="form-control validate" value="<?php echo e($item->pivot->q2); ?>" >
                                </div>

                                <div class="md-form mb-5">
                                        <label data-error="wrong" data-success="right" for="defaultForm-instruction">Q3</label>
                                        <input type="number" name="q3" id="defaultForm-instruction" class="form-control validate" value="<?php echo e($item->pivot->q3); ?>">
                                </div>  

                                <div class="md-form mb-5">
                                    <label data-error="wrong" data-success="right" for="defaultForm-instruction">Q4</label>
                                    <input type="number" name="q4" id="defaultForm-instruction" class="form-control validate" value="<?php echo e($item->pivot->q4); ?>">
                                </div>  
