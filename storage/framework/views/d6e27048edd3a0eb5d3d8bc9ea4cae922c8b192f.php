        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu"> 
                    ...
                    <li>    
                        <a href="<?php echo e(route('budget.plans')); ?>" class="<?php echo e(Route::currentRouteName() === 'budget.plans' ? 'active' : ''); ?>"><i class="fa fa-table fa-fw " ></i>For Approval Plan <span class="badge"><?php echo e($budgetPlans->count()); ?></span></a>
                    </li>
                    <li>    
