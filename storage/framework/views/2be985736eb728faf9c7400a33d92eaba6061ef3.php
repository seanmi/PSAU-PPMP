                                ...
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                                ...
                                                <a href="<?php echo e(route('vp.plan.items', ['id' => $item->plan->id])); ?>" class="btn btn-warning ">Plan Items</a>
                                                <a href="<?php echo e(route('vp.approved', ['id' => $item->id])); ?>"  class="btn btn-primary " id="approve">Approve</a>
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <form action="<?php echo e(route('vp.disapproved', ['id' => $item->id])); ?>" method="POST">
                                        ...
                                        <div class="modal-body" id="modal<?php echo e($item->id); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $item->plan->planItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                            <input  class="form-control input-sm" type="number" name="amount<?php echo e($item->id); ?>" readonly value="<?php echo e($i->pivot->estimated_budget); ?>">
                                                            </div>
                                                        </div>                                                        
