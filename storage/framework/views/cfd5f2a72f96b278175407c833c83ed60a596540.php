                            ...
                            <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center btn-group">
                                        <a href="" data-toggle="modal" data-target="#s<?php echo e($item->id); ?>"  class="btn btn-warning ">View Submission</a>
                                        <a href="<?php echo e(route('bac.consolidation', ['id' => $item->id])); ?>" class="btn btn-success ">Consolidation</a>
                                    </td>
                                </tr>
