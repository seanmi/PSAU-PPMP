                                ...
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo e(route('show.items', ['id' => $item->id])); ?>" class="btn btn-secondary ">View Items</a>
                                            <a href="<?php echo e(route('user.plan.submit', ['id' => $item->id])); ?>" class="btn btn-primary ">Submit Plan</a>
                                        ...
                                        <div class="panel-body">
                                            <form  action="" id="form" method="POST">
                                                ...
                                                <div class="row" id="fields">
                                                    <?php $__currentLoopData = $item->planItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="panel-footer">
                                                    <div class="text-right " style="padding-right: 17rem">
                                                            <?php $__currentLoopData = $item->planItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
