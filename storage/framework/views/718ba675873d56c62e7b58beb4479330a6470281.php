                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo e(route('category.delete', ['id' => $item->id])); ?>">Delete</a>
                                    </td>
                                </tr>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('category.update', ['id' => $item->id])); ?>" method="POST">
...
<div class="modal fade" id="modalLoginForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('category.store')); ?>" method="POST" id="category_form">
        <?php echo e(csrf_field()); ?>
