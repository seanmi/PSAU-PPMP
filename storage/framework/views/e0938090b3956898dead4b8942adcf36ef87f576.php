                    ...
                    <form role="form" action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="Username" name="email" type="text" value="<?php echo e(old('email')); ?>" required autofocus>
