    ...
    $('[data-toggle="tooltip"]').tooltip(); 
        ...
        $elm = $('#aw');
            ...
            $('#list_item').change(function(){ 
                ...
                addedItem += '<div class="col-lg-1 col-md-12  form-group"><label class="hidden-lg" for="id">Price</label><input type="number" class="form-control input-sm price" id="email" placeholder="'+"₱"+price.toFixed(2)+'" data-toggle="tooltip" title="'+"₱"+price.toFixed(2)+'"  readonly></div>';
                addedItem += '<div class="col-lg-1 col-md-12 form-group"><label class="hidden-lg" for="id">Quantity</label><input type="number" data-price="'+price+'" name="quantity[]" class="form-control input-sm price" id="email" placeholder="Quantity" required></div>';
