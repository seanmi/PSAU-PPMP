    ...
    var quantity = "";
        ...
        $elm = $('#aw');
            ...
            $('#list_item').change(function(){ 
                ...
                addedItem += '<div class="col-sm-3 form-group"><input type="text" class="form-control input-sm gen" id="email" placeholder="'+gen+'" readonly></div>';
                ...
                addedItem += '<div class="col-sm-2 form-group"><input type="number" class="form-control input-sm price" id="email" placeholder="'+price+'" readonly></div>';
                addedItem += '<div class="col-sm-2 form-group"><input type="number" data-price="'+price+'" name="quantity[]" class="form-control input-sm price" id="email" required></div>';
