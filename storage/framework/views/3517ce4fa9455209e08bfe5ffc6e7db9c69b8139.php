                            ...
                            <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center btn-group">
                                        <?php if($plans): ?>
                                        <a href="<?php echo e(route('user.plan.items', ['id' => $plans->id])); ?>" class="btn btn-warning ">View Plan</a>
                                        <a href="" data-toggle="modal" data-target="#v<?php echo e($item->id); ?>" class="btn btn-primary ">Submit</a>                                            
                                        <?php endif; ?> 
                                ...
                                <div class="modal fade" id="v<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <form action="<?php echo e(route('user.plan.submit', ['id'=> $item->id])); ?>" method="POST" id="form_submit">
                                                    ...
                                                    <div class="md-form mb-5">
                                                        <select name="plan_id" id="" class="form-control validate">
                                                            <?php if($plans): ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <option value="<?php echo e($plans->id); ?>"><?php echo e($plans->name); ?></option>                                                                 
                                                            <?php endif; ?>                                                       
                                                        </select>
                                                    </div>                   
                                                </div>
