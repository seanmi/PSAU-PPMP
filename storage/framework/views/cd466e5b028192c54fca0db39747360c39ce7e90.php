...
<div class="row">
    <div class="col-lg-12">
        <div class="page-header">
            <div class="row">
                <div class="col-md-9"><h1 ><?php echo e($plan->name); ?></h1></div>
                <div class="col-md-3"><br>
                        <div class="btn-group">
                            <?php if($approval->approved == 0): ?>
                                <a href="<?php echo e(route('vp.approved', ['id' => $approval->id])); ?>" class="btn btn-primary ">Approve</a>                               
                            <?php else: ?>
                                <h5>Approved Date: <?php echo e($approval->updated_at); ?></h5>
                            <?php endif; ?>
                        </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="" id="print">
                    ...
                    <table class="table table-bordered" id="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="4" rowspan="2"> <?php echo e($plan->budget->user->department->name); ?></td>
                            </tr>
                            <tr>
                                ...
                                <?php $__currentLoopData = $plan->planItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item->category_id == $category->id): ?>
                                        <tr> 
                                            ...
                                            <td>₱<?php echo e(number_format($item->pivot->estimated_budget, 2)); ?></td>
                                            <td></td>
                                            <td ><?php echo e($item->pivot->q1); ?></td>
                                            <td><?php echo e($item->pivot->q2); ?></td>
                                            <td><?php echo e($item->pivot->q3); ?></td>
                                            <td><?php echo e($item->pivot->q4); ?></td>
                            ...
                            <tr >
                                    ...
                                    <td colspan="3" style="text-align: right !important"> 
                                        ₱<?php echo e(number_format($plan->planItem()->sum('estimated_budget'), 2)); ?>

                                    </td>
                            </tr>
                            <tr>
                                <td colspan="2">+ 10% Provision for Inflation</td>
                                <td colspan="3" style="text-align: right !important">₱<?php echo e(number_format($plan->planItem()->sum('estimated_budget')* .10, 2)); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                    ...
                                    <td colspan="3" style="text-align: right !important">₱<?php echo e(number_format( (($plan->planItem()->sum('estimated_budget')* .10)*2)+ $plan->planItem()->sum('estimated_budget') ,  2)); ?></td>
                                </tr>
                            </table>
                        </tbody>
                    </table>
                    ...
                    <div class="row text-center">
                        <div class="col-sm-4"><strong><?php echo e($plan->budget->user->name); ?></strong><hr></div>
                        <div class="col-sm-4"><strong><?php echo e($vp->name); ?></strong><hr></div>
                        <div class="col-sm-4"> <strong>HONORIO M. SORIANO JR.</strong> <hr></div>
                    </div>
                    <div class="row text-center">
                        <div class="col-sm-4">End User</div>
                        <div class="col-sm-4">VP for <?php echo e($vp->department->group->name); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>