                            ...
                            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <?php if($item->plan->state == 5 && $item->submission->active == 1): ?>
                                                <a href="<?php echo e(route('user.plan.items', ['id' => $item->plan->id])); ?>"  class="btn btn-success ">Insert Items</a>                                               
                                            <?php endif; ?>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('user.plan.update', ['id' => $item->id])); ?>" method="POST" id="item_form">
