                            ...
                            <?php $__currentLoopData = $approvals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                                <a href="" data-toggle="modal" data-target="#v<?php echo e($item->id); ?>" onclick="calc(<?php echo e($item->id); ?>)" class="btn btn-warning ">Plan Items</a>
                                                <a href="<?php echo e(route('vp.approved', ['id' => $item->id])); ?>"  class="btn btn-primary ">Approve</a>
                                        </div>
                                    </td>
                                </tr>
